...
f = open(os.path.join(sys.path[0], "localization_lenght_W3.txt"), 'w')     # Quando si cambia W, è necessario cambiare
for j in range(0, dim):                                                    # anche il nome del file di output
